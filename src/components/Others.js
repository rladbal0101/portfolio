  ...
  return (
    <OtherWraaper className='mt-5' id='other'>
      ...
      <Other className='mt-5'>
        ...
        <div className='mt-3'>
          <p>
            인천국제공항 제2터미널의 홈페이지 리뉴얼 작업에 참여한 경험이 있습니다. 제2터미널의 오픈을 기념하여 홈페이지를 새롭게 구성하고 개선하는 작업이었습니다. 제가 맡은 역할은 메인페이지의 작업과 서브페이지의 구현이었습니다. 메인페이지는 제2터미널을 대표하는 이미지와 정보를 효과적으로 전달하기 위해 다양한 디자인 요소와 기능을 포함하고 있었습니다. HTML, CSS, JavaScript를 활용하여 웹페이지를 구성하고, 사용자 경험을 향상시키기 위해 반응형 웹 디자인을 적용했습니다. 웹 접근성을 고려하여 웹페이지의 구조와 디자인을 최적화하는 작업을 수행했습니다. 서브페이지 구현은 메인페이지와의 일관성을 유지하면서도 각각의 서브페이지마다 필요한 내용과 기능을 제공해야 했습니다.
          </p>
          <p className='mt-1'>
            프로젝트를 통해 프론트엔드 개발에 대한 실무 경험을 쌓을 수 있었고, 협업과 커뮤니케이션의 중요성을 깨닫게 되었습니다. 제2터미널 홈페이지 리뉴얼은 많은 사람들에게 사용되는 중요한 웹페이지였기 때문에, 정확한 요구사항을 파악하고 효율적인 작업을 위해 팀원들과의 원활한 소통이 필요했습니다. 프로젝트 기간 동안 발생하는 문제를 해결하고, 일정을 맞추기 위해 노력했습니다. 앞으로도 다양한 프로젝트에 도전하여 실력을 향상시키고, 최신 웹 기술과 트렌드를 습득하여 사용자에게 더 나은 경험을 제공하는 프론트엔드 개발자로 성장하고 싶습니다.
          </p>
        </div>
      </Other>
    </OtherWraaper>
